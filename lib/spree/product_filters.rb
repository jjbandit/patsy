    ...
    module ProductFilters
      ...
      def ProductFilters.price_filter
        ...
        conds = [ [ Spree.t(:under_price, price: format_price(10))     , v[:amount].lteq(10)],
                  ...
                  [ "#{format_price(21)} - #{format_price(30)}"        , v[:amount].in(21..30)],
                  [ "#{format_price(31)} - #{format_price(40)}"        , v[:amount].in(31..40)],
                  [ Spree.t(:or_over_price, price: format_price(40)) , v[:amount].gteq(41)]]
        {
